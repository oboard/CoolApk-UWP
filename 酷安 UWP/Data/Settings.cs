...
namespace CoolapkUWP.Data
{
    static class Settings
    {
        ...
        public static Thickness titleTextMargin => new Thickness(5, 8, 5, 12);
        ...
        public static async void CheckUpdate()
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    var keys = Windows.Data.Json.JsonObject.Parse(await client.GetStringAsync("https://api.github.com/repos/oboard/Coolapk-UWP/releases/latest"));
